        ...
        <FusePageSimple
            header={
                <Box
                    ...
                    sx={{
                        backgroundColor: '#1a2730', //'primary.main'
                        color: 'white', //  (theme) => theme.palette.getContrastText(theme.palette.primary.main)
                    }}
                >
                    <div className="flex flex-col items-center justify-center  mx-auto w-full">
                        {/*  <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1, transition: { delay: 0 } }}>*/}
                        {/*    <Typography color="inherit" className="text-18 font-semibold">*/}
                        {/*      FUSE ACADEMY (оовововово)*/}
                        {/*    </Typography>*/}
                        {/*  </motion.div>*/}
                        <motion.div initial={{opacity: 0}} animate={{opacity: 1, transition: {delay: 0}}}>
                            <Typography
                    ...
                    >
                        <g
                            ...
                            {/*<rect x="20" width="100" height="100"/>*/}
                        <line x1="1100" y1="170" x2="500" y2="170"/>
                            {/*<path stroke="currentColor" d="M1000 0 500 0" />*/}
            ...
            content={
                <div className="flex flex-col flex-1 w-full mx-auto px-24 pt-24 sm:p-40">
                    <div
                        className="flex flex-col shrink-0 sm:flex-row items-center justify-between space-y-16 sm:space-y-0">
                        <div
                            className="flex flex-col sm:flex-row w-full sm:w-auto items-center space-y-16 sm:space-y-0 sm:space-x-16">
